	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="panel panel-default">
                ...
                <thead>
                  <tr>
                    <th><i class="fa fa-list-ol"></i>Transaction_id</th>
                    <th><i class="fa fa-user"></i> Client</th>
                    <th><i class="fa fa-transgender-alt"></i> Payment_id</th>
                   <!--  <th><i class="fa fa-address"></i> Payment_Transaction_ID</th> -->
                    <th><i class="fa fa-address"></i> Payment_Details</th>
                    <th><i class="fa fa-address"></i> Amount</th>
                    <th><i class="fa fa-address"></i> Created_Dt</th>
          ...
          foreach($data as $datas){
            ...
            <td><?php echo strtoupper($datas['amount']); ?></td>
              ...
              <div class="w3-modal-content" style="width:30%">
                ...
                <div class="w3-card-4 w3-white">
                  <div class="w3-container w3-center">
                    ...
                    <h5 class="w3-large"><i class="fa fa-id-card-o"></i> <?php echo $datas['transaction_id']; ?></h5>
                    <h5 class="w3-large"><i class="fa fa-user"></i> <?php echo $datas['firstname']; ?></h5>
                    <h5 class="w3-small"><i class="fa fa-share-alt"></i> <?php echo ' : '.$datas['payment_details']; ?></h5>
                    <h5 class="w3-small"><i class="fa fa-share-alt"></i> <?php echo ' : '.$datas['amount']; ?></h5>
                  </div>
                </div>
              </div>
            </div>
