...
<?php
  if(isset($_POST['add'])){
    ...
    if($gender != '' && $address != '' && $firstname != '' && $lastname != ''){
		$staff_id=addStaffByBusId($bus_id,$firstname,$lastname,$gender,$address);
			...
			<div class="panel panel-default">
                ...
                <thead>
                  <tr>
                    ...
                    <th><i class="fa fa-address"></i> Address</th>
              ...
              <div class="w3-modal-content" style="width:30%">
                ...
                <div class="w3-card-4 w3-white">
                  <div class="w3-container w3-center">
                    ...
                    <h5 class="w3-small"><i class="fa fa-share-alt"></i> <?php echo ' : '.$datas['address']; ?></h5>
        ...
        <form method="POST" class="w3-container w3-margin">
          <div class="w3-row w3-section">
           ...
           <p><label><b>Services</b></label><br/>
                    	 ...
                    	 foreach($data as $datas){
                    	 ?>
                       <input type="checkbox" name="service_id[]" value="<?php echo $datas['service_id'] ;?>"><?php echo $datas['service_id'] .' '.$datas['service_name']; ; ?>
                       <?php
                       }
          				?>
              </p>
