...
<body>
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="transaction.php"><em class="fa fa-addresss-book-o">&nbsp;</em> Transactions</a></li>
			<li class="active"><a href="appointment.php"><em class="fa fa-calendar">&nbsp;</em> Appoinments</a></li>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="panel panel-container">
			<div class="panel panel-default">
                ...
                <thead>
                  <tr>
                    ...
                    <th><i class="fa fa-user"></i> Transaction_id</th>
                    <th><i class="fa fa-transgender-alt"></i> Client</th>
                     <th><i class="fa fa-address"></i> Service</th>
                    <th><i class="fa fa-address"></i> Start_time</th>
                    <th><i class="fa fa-address"></i> End_time</th>
                    <th><i class="fa fa-address"></i> Sched_date</th>
                    <th><i class="fa fa-address"></i> Staff</th>
          ...
          foreach($data as $datas){
            ...
            <td><?php echo strtoupper($datas['service_name']); ?></td>
            <td><?php echo strtoupper($datas['start_time']); ?></td>
            <td><?php echo strtoupper($datas['end_time']); ?></td>
            <td><?php echo strtoupper($datas['sched_date']); ?></td>
            <td><?php echo strtoupper($datas['firstname']); ?></td>
