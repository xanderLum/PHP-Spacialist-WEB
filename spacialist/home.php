...
?>
<!-- <?php
	 /* require_once 'http://localhost/spacialist/notificationController/readNotification.php';*/
?> -->
<?php
			...
			<div class="navbar-header">
				...
				<ul class="nav navbar-top-links navbar-right">
					<li class="dropdown"><a class="dropdown-toggle count-info" data-toggle="dropdown" href="#">
						<em class="fa fa-bell"></em><span class="label label-danger">
							<?php  $bus_id=$_SESSION["bus_id"];?><?php echo CountNotification($bus_id)?></span>
					</a>
				...
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-red panel-widget border-right ">
						<div class="row no-padding"><em class="fa fa-xl fa-calendar color-red"></em>
							<div class="large"><div class="count"><?php  $bus_id=$_SESSION["bus_id"];?><?php echo DashboardAppointments($bus_id)?></div></div>
							<div class="text-muted"><font color="black">Appointments</font></div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-teal panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-address-book-o color-blue"></em>
							<div class="large"><div class="count"><?php  $bus_id=$_SESSION["bus_id"];?><?php echo DashboardStaff($bus_id)?></div></div>
							<div class="text-muted"><font color="black">Staff</font></div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-orange panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-users color-teal"></em>
							<div class="large"><div class="count"><?php  $bus_id=$_SESSION["bus_id"];?><?php echo DashboardClients($bus_id)?></div></div>
							<div class="text-muted"><font color="black">Clients</font></div>
						</div>
					</div>
				</div>
				<div class="col-xs-6 col-md-3 col-lg-3 no-padding">
					<div class="panel panel-blue panel-widget border-right">
						<div class="row no-padding"><em class="fa fa-xl fa-book color-orange"></em>
							<div class="large"><div class="count"><?php  $bus_id=$_SESSION["bus_id"];?><?php echo DashboardBookings($bus_id)?></div></div>
							<div class="text-muted"><font color="black">Bookings</font></div>
						</div>
					</div>
				</div>
			</div><!--/.row-->
